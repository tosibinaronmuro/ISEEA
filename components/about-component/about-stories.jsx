...
<div
  class="rounded-lg border border-gray-100 bg-secondary font-Poiret font-semibold  p-4 shadow-sm transition hover:shadow-lg sm:p-6"
>

  <p class="mt-2 line-clamp-4 text-sm/relaxed lg:text-lg text-tertiary">
  ...
  <a
    href="/stories"
    class="group mt-4 inline-flex items-center gap-1 text-sm/relaxed lg:text-lg font-medium text-blue-600"
  >
    Find out more
