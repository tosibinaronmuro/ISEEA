...
const SuccessAlert = ({ message }) => {
  return (
    <div
      id="alert-2"
      className=" col-span-10 mx-2 flex justify-between items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50    "
      role="alert"
    >
      <div className="flex">
        <svg
        ...
        <div className="ml-3 flex justify-center items-center text-sm font-medium">
          {message} <span className="capitalize ml-1"></span>
        </div>
      </div>
      {/* <button
        type="button"
