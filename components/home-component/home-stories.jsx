  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-row gap-x-5 lg:py-5">
        ...
        <div className="rounded-lg border border-gray-100 bg-white font-Poiret font-semibold  p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          ...
          <a
            href="/stories"
            className="group mt-4 hover:animate-waving-hand inline-flex items-center gap-1 text-sm/relaxed lg:text-lg font-semibold text-primary"
          >
            Find out more
            <span
              aria-hidden="true"
