...
<ol className="relative border-l ml-9 border-tertiary  ">                  
    <li className="mb-10 ml-4">
        ...
        <h3 className="text-lg lg:font-semibold text-gray-900  ">Application UI code in Tailwind CSS</h3>
    ...
    <li className="mb-10 ml-4">
        ...
        <h3 className="text-lg lg:font-semibold text-gray-900 dark:text-white">Marketing UI design in Figma</h3>
    ...
    <li className="ml-4">
        ...
        <h3 className="text-lg lg:font-semibold text-gray-900 dark:text-white">E-Commerce UI code in Tailwind CSS</h3>
