...
const TeamMember = ({photo,name,position,bio}) => {
  return (
    <div   className="group relative block bg-tertiary min-w-[97%] max-w-[98%] min-h-[75vh] lg:min-h-auto  md:min-w-[40%]  h-auto   md:max-w-[45% ] md:max-w-[45%] lg:w-[30%]">
  <img
    alt="Developer"
    src={photo}
  ...
  <div className="relative p-4 sm:p-6 lg:p-8">
    ...
    <p className="  font-bold text-white font-Poiret text-lg lg:text-2xl">{name}</p>
